local content = game:HttpGet("https://github.com/linemaster2/storage/blob/main/Silkscreen-Regular.ttf?raw=true");

if not isfile("linebob/Silkscreen-Regular.ttf") then
	writefile("linebob/Silkscreen-Regular.ttf", content);
end;

--// not made by me
local HttpService = game:GetService("HttpService");

writefile("linebob/font.ttf", HttpService:JSONEncode({
	["name"] = "silk",
	["faces"] = {
		{
			["name"] = "Regular",
			["weight"] = 100,
			["style"] = "normal",
			["assetId"] = getcustomasset("linebob/Silkscreen-Regular.ttf")
		}
	}
}))

local FontObject = Font.new(getcustomasset("linebob/font.ttf"), Enum.FontWeight.Regular, Enum.FontStyle.Normal)

delfile("linebob/font.ttf")
